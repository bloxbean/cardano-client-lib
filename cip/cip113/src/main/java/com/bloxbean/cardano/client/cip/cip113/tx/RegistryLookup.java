...
public interface RegistryLookup {
     ...
     * but a transaction that registers or updates a node invalidates that view, and so does any
     * registration made elsewhere. Call this after changing the registry, and before an operation
     * whose correctness depends on a policy being <i>absent</i>.</p>
     */
