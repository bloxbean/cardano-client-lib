...
class CIP30ValueTest {

    @Test
    void deserializationTest() throws CborDeserializationException {
        ...
        Assertions.assertEquals(expected, CIP30ValueDeserializer.deserialize(HexUtil.decodeHexString(cbor)));
    }

    @Test
    void serializeDeserializeTest() throws CborSerializationException, CborDeserializationException {
        ...
        String actual = HexUtil.encodeHexString(CIP30ValueSerializer.serialize(value));
        Assertions.assertEquals(expected, actual);
        Assertions.assertEquals(value, CIP30ValueDeserializer.deserialize(HexUtil.decodeHexString(actual)));
    }
}
