...
class CardanoVrfBenchmarkTest {
    ...
    private static final byte[] VRF_VKEY = decodeHexString(
            "5ebd45dfdf4ee76829d195ec24771904ee3947387f3e65005deb2b7ceab393c0");
    private static final byte[] VRF_PROOF = decodeHexString(
    ...
    private static final byte[] VRF_OUTPUT = decodeHexString(
    ...
    private static final byte[] EPOCH_NONCE = decodeHexString(
