...
class AddressServiceTest {
    ...
    void getStakeKeyHash_fromTestnetEntAddress_returnsNull() {
        ...
        Optional<byte[]> stakeKeyHash = AddressService.getInstance().getStakeKeyHash(address);
        assertThat(stakeKeyHash).isEmpty();
    }
    ...
    void getStakeKeyHash_fromBaseAddress_testnet() {
        ...
        assertThat(HexUtil.encodeHexString(stakeKeyHash)).isEqualTo("15ce7df979c85bf8363b53a7b36fc30e972217a9dc5336d034f5ba1b");
    }
    ...
    void getStakeKeyHash_fromBaseAddress_mainnet() {
        ...
        byte[] stakeKeyHash = AddressService.getInstance().getStakeKeyHash(address).get();
        assertThat(HexUtil.encodeHexString(stakeKeyHash)).isEqualTo("8b68a4f91fbfd17cf108fc1996d831d991a672f4160d536d11525a9d");
    }
    ...
    void getStakeKeyHash_fromRewardAddress_testnet() {
        ...
        byte[] stakeKeyHash = AddressService.getInstance().getStakeKeyHash(address).get();
        assertThat(HexUtil.encodeHexString(stakeKeyHash)).isEqualTo("548dda292c35fa3f37dab502db896948a45b365f1462479d73056a71");
    }
    ...
    void getStakeKeyHash_fromRewardAddress_mainnet() {
        ...
        byte[] stakeKeyHash = AddressService.getInstance().getStakeKeyHash(address).get();
        assertThat(HexUtil.encodeHexString(stakeKeyHash)).isEqualTo("e9e4960a8529a9a72de7c96976a52ed83cb4739681c0854956c3cdc1");
    }
