...
public class AddressTest {
    ...
    class GetDelegationHashAndPaymentKeyHashTest {
        ...
        void getStakeKeyHash_fromBaseAddress_testnet() {
            ...
            byte[] delegationHash = address.getDelegationCredentialHash().get();
        ...
        void getPaymentKeyHash_fromBaseAddress_mainnet() {
            ...
            byte[] paymentKeyHash = address.getPaymentCredentialHash().get();
        ...
        void getPaymentKeyHash_fromStakeAddress_mainnet() {
            ...
            Optional<byte[]> paymentKeyHash = address.getPaymentCredentialHash();
    ...
    class GetDelegationAndPaymentCredentialTest {
        ...
        void getStakeCredential_fromTestnetEntAddress_returnsNull() {
            ...
            Optional<Credential> delegCred = address.getDelegationCredential();
            assertThat(delegCred).isEmpty();
        }
        ...
        void getStakeCredential_fromBaseAddress_testnet() {
            ...
            Credential delegCred = address.getDelegationCredential().get();
            assertThat(HexUtil.encodeHexString(delegCred.getBytes())).isEqualTo("15ce7df979c85bf8363b53a7b36fc30e972217a9dc5336d034f5ba1b");
        }
        ...
        void getStakeCredential_fromBaseAddress_mainnet() {
            ...
            Credential delegCred = address.getDelegationCredential().get();
            assertThat(HexUtil.encodeHexString(delegCred.getBytes())).isEqualTo("8b68a4f91fbfd17cf108fc1996d831d991a672f4160d536d11525a9d");
        }
