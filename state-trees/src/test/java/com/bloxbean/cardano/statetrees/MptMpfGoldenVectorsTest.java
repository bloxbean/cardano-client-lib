...
class MptMpfGoldenVectorsTest {
    ...
    void mango_and_kumquat_proof_cbor_match_mpf_repo() {
        ...
        assertTrue(com.bloxbean.cardano.statetrees.mpt.mpf.MpfProofVerifier.verify(trie.getRootHash(), b("mango[uid: 0]"), b("🥭"), true, mangoCbor, hashFn, new com.bloxbean.cardano.statetrees.mpt.commitment.MpfCommitmentScheme(hashFn)));
        ...
        assertTrue(com.bloxbean.cardano.statetrees.mpt.mpf.MpfProofVerifier.verify(trie.getRootHash(), b("kumquat[uid: 0]"), b("🤷"), true, kumquatCbor, hashFn, new com.bloxbean.cardano.statetrees.mpt.commitment.MpfCommitmentScheme(hashFn)));
