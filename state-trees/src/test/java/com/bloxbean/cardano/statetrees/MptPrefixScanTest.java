...
public class MptPrefixScanTest {
  ...
  private static void put(MerklePatriciaTrie t, String k, String v) { t.put(hex(k), v.getBytes()); }
  private static String s(byte[] b) { return new String(b); }
  ...
  private static String hexStr(byte[] b) { StringBuilder sb=new StringBuilder(); for(byte x:b) sb.append(String.format("%02x", x)); return sb.toString(); }
}
