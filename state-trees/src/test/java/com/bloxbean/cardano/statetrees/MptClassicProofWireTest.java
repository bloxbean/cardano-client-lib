...
class MptClassicProofWireTest {
    ...
    void non_inclusion_missing_branch_classic_wire() {
        ...
        // Also via public ClassicProof API
        com.bloxbean.cardano.statetrees.api.ClassicProof classic = com.bloxbean.cardano.statetrees.api.ClassicProof.fromWire(wire);
        assertTrue(com.bloxbean.cardano.statetrees.mpt.ClassicProofVerifier.verifyNonInclusion(
                root, HF, target, classic, new com.bloxbean.cardano.statetrees.mpt.commitment.ClassicMptCommitmentScheme(HF)));
    }
    ...
    void cross_mode_mismatch_throws() {
        ...
        // MPF trie (default)
        MerklePatriciaTrie mpfTrie = new MerklePatriciaTrie(store, HF);
