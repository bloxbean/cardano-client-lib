...
public final class NodePersistence {
    ...
    private byte[] computeExtensionCommit(ExtensionNode ext) {
        com.bloxbean.cardano.statetrees.common.nibbles.Nibbles.HP hpInfo = com.bloxbean.cardano.statetrees.common.nibbles.Nibbles.unpackHP(ext.getHp());
        com.bloxbean.cardano.statetrees.common.NibblePath accPrefix = com.bloxbean.cardano.statetrees.common.NibblePath.of(hpInfo.nibbles);
        ...
        while (current instanceof ExtensionNode) {
            ...
            com.bloxbean.cardano.statetrees.common.nibbles.Nibbles.HP hpInfo2 = com.bloxbean.cardano.statetrees.common.nibbles.Nibbles.unpackHP(nextExt.getHp());
            accPrefix = accPrefix.concat(com.bloxbean.cardano.statetrees.common.NibblePath.of(hpInfo2.nibbles));
        ...
        if (current instanceof BranchNode) {
            ...
            com.bloxbean.cardano.statetrees.common.nibbles.Nibbles.HP leafHp = com.bloxbean.cardano.statetrees.common.nibbles.Nibbles.unpackHP(leaf.getHp());
            com.bloxbean.cardano.statetrees.common.NibblePath suffix = accPrefix.concat(com.bloxbean.cardano.statetrees.common.NibblePath.of(leafHp.nibbles));
