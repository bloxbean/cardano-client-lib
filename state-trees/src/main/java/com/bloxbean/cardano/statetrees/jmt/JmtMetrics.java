...
/**
 * Metrics collection interface for JMT V2 operations.
 *
 ...
 * JellyfishMerkleTreeV2.Options options = JellyfishMerkleTreeV2.Options.builder()
 *     .metrics(metrics)
 *     .build();
 *
 * // Without metrics (default)
 * JellyfishMerkleTreeV2.Options options = JellyfishMerkleTreeV2.Options.defaults(); // metrics = NOOP
 * </pre>
 *
...
public interface JmtMetrics {
     ...
     *
     * <p><b>Note:</b> Currently not implemented in JellyfishMerkleTreeV2.
     * JMT V2 focuses on batch commits and proof generation. Individual reads
