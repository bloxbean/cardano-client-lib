...
import com.bloxbean.cardano.statetrees.rocksdb.gc.NodeRefParser;
import org.rocksdb.*;
...
public final class RocksDbStorageRepository implements StorageRepository {
     ...
     */
    private static class RefCountKey extends com.bloxbean.cardano.statetrees.rocksdb.keys.RocksDbKey {
     ...
     */
    private static class VersionKey extends com.bloxbean.cardano.statetrees.rocksdb.keys.RocksDbKey {
