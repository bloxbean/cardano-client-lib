...
Transaction signedTx = new TxBuilderContext(utxoSupplier, paramsSupplier)
...
- `new TxBuilderContext(UtxoSupplier, ProtocolParamsSupplier|ProtocolParams)`: creates the execution context.
