...
```gradle
dependencies {
    implementation 'com.bloxbean.cardano:merkle-patricia-forestry:0.8.0-pre5'
    implementation 'com.bloxbean.cardano:merkle-patricia-forestry-rocksdb:0.8.0-pre5'
