...
> **See also:**
> - [Plutus Blueprint Code Generation](/smart-contracts/blueprint-codegen/) — generate type-safe Java bindings from a blueprint using annotations
> - [Aiken Integration](/smart-contracts/aiken/) — Script cost evaluation and parameterized contracts
> - [Scalus Integration](/smart-contracts/scalus/) — Script cost evaluation and parameterized contracts
