...
class ReachabilityMetadataTest {
    ...
    private static final String METADATA =
            "/META-INF/native-image/com.bloxbean.cardano/cardano-client-common-spec/reachability-metadata.json";
    ...
    private static final List<String> PACKAGES = List.of("com.bloxbean.cardano.client.spec");
