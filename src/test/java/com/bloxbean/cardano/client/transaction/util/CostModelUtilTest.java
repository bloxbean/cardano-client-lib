...
class CostModelUtilTest {
    ...
    void getCostModelFromProtocolParams() {
        ...
        CostModel v1CostModel = CostModelUtil.getCostModelFromProtocolParams(protocolParams, Language.PLUTUS_V1);
        CostModel v2CostModel = CostModelUtil.getCostModelFromProtocolParams(protocolParams, Language.PLUTUS_V2);

        assertThat(v1CostModel.getCosts()).isEqualTo(new long[]{205665L, 31220L, 1021L, 10L});
        assertThat(v2CostModel.getCosts()).isEqualTo(new long[]{205665L, 812L, 1000L, 10L});
    }
