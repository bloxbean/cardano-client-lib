...
/**
 * Base class for converting JsonNode structures to Metadata objects.
 * This class provides shared functionality for both JSON and YAML to metadata conversion,
 * as both formats can be parsed into JsonNode structures.
 */
public class JsonNodeToMetadataConverter {

    /**
     * Parses a top-level JsonNode object into CBORMetadata
     * @param jsonNode the root JsonNode to parse
     * @return CBORMetadata object
     * @throws MetadataSerializationException if the JsonNode is not an ObjectNode
     */
    public static Metadata parseJsonNode(JsonNode jsonNode) {
        if(jsonNode instanceof ObjectNode) {
            return parseTopJsonObject((ObjectNode) jsonNode);
        } else {
            throw new MetadataSerializationException("Invalid node type. Expected ObjectNode but got: " + jsonNode.getNodeType());
        }
    }

    /**
     * Parses the top-level JSON object into CBORMetadata
     * @param objectNode the ObjectNode to parse
     * @return CBORMetadata containing the parsed data
     */
    protected static CBORMetadata parseTopJsonObject(ObjectNode objectNode) {
    ...
    /**
     * Parses an ArrayNode into CBORMetadataList
     * @param value the ArrayNode to parse
     * @return CBORMetadataList containing the parsed elements
     */
    ...
    /**
     * Parses an ObjectNode into CBORMetadataMap
     * @param jsonObj the ObjectNode to parse
     * @return CBORMetadataMap containing the parsed key-value pairs
     */
    ...
    /**
     * Processes a JsonNode value and converts it to the appropriate CBOR type
     * @param value the JsonNode to process
     * @return the corresponding CBOR value (CBORMetadataMap, CBORMetadataList, String, byte[], BigInteger, or null)
     */
    protected static Object processValueNode(JsonNode value) {
