...
public abstract class AbstractTx<T> {
     ...
     * @return Tx
     */
    public T mintAssets(@NonNull Script script, Asset asset) {
     ...
     * @return Tx
     */
    public T mintAssets(@NonNull Script script, Asset asset, String receiver) {
     ...
     * @return Tx
     */
    public T mintAssets(@NonNull Script script, List<Asset> assets) {
     ...
     * @return Tx
     */
    public T mintAssets(@NonNull Script script, List<Asset> assets, String receiver) {
        try {
