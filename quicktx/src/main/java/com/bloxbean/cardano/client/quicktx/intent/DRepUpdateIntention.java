...
/**
 * Intention for DRep update operations.
 * Maps to GovTx.updateDRep(Credential, Anchor, PlutusData) operations.
 */
@Data
...
public class DRepUpdateIntention implements TxIntention {
    ...
    public void validate() {
        if (drepCredential == null && (drepCredentialHex == null || drepCredentialHex.isEmpty())) {
            throw new IllegalStateException("DRep credential is required for update");
        }
