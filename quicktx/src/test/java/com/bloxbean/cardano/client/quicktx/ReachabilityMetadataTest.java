...
class ReachabilityMetadataTest {
    ...
    private static final String METADATA =
            "/META-INF/native-image/com.bloxbean.cardano/cardano-client-quicktx/reachability-metadata.json";
    /** Packages (including sub-packages) whose classes Jackson binds reflectively. */
    private static final List<String> RECURSIVE_PACKAGES = List.of();
    /** Packages (without sub-packages) whose classes Jackson binds reflectively. */
    private static final List<String> PACKAGES = List.of("com.bloxbean.cardano.client.quicktx.intent", "com.bloxbean.cardano.client.quicktx.serialization");
