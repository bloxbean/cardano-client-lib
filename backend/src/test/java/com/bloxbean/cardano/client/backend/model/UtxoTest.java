...
class UtxoTest {
    ...
    void toValue() {
        ...
        Assertions.assertThat(value.getMultiAssets()).hasSize(3);
        Assertions.assertThat(value.getCoin()).isEqualTo(BigInteger.valueOf(140000));

        Assertions.assertThat(ma1.getAssets()).hasSize(1);
        Assertions.assertThat(ma1.getAssets().get(0)).isEqualTo(new Asset("0x", BigInteger.valueOf(222)));

        Assertions.assertThat(ma2.getAssets()).hasSize(3);
        Assertions.assertThat(ma2.getAssets()).contains(
        ...
        Assertions.assertThat(ma3.getAssets()).hasSize(2);
        Assertions.assertThat(ma3.getAssets()).contains(
    ...
    void toValue_whenNoMultiAsset() {
        ...
        System.out.println(value);
        Assertions.assertThat(value.getCoin()).isEqualTo(BigInteger.valueOf(140000));
        Assertions.assertThat(value.getMultiAssets()).hasSize(0);
    }
    ...
    void toValue_whenOneMultiAsset() {
        ...
        System.out.println(value);
        Assertions.assertThat(value.getCoin()).isEqualTo(BigInteger.valueOf(140000));
        Assertions.assertThat(value.getMultiAssets()).hasSize(1);
        Assertions.assertThat(value.getMultiAssets().get(0).getPolicyId()).isEqualTo("5acc52d5696e52345aec108468050d9d743eb21d6e41305bbc23a27b");
        Assertions.assertThat(value.getMultiAssets().get(0).getAssets()).contains(
                new Asset("0x616263", BigInteger.valueOf(5000))
        );
    }
}
