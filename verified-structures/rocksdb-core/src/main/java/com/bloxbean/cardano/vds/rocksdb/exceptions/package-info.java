 ...
 * <ul>
 *   <li>{@link com.bloxbean.cardano.vds.rocksdb.exceptions.RocksDbStorageException} -
 *       Base class for all storage-related errors</li>
 *   <li>{@link com.bloxbean.cardano.vds.rocksdb.exceptions.RocksDbOperationException} -
 *       Specific operation failures (GET, PUT, DELETE, etc.)</li>
 *   <li>{@link com.bloxbean.cardano.vds.rocksdb.exceptions.RocksDbBatchException} -
 *       Batch operation failures with batch context</li>
 *   <li>{@link com.bloxbean.cardano.vds.rocksdb.exceptions.RocksDbConfigurationException} -
 ...
 *     if (e.isOperation("PUT")) {
 *         // Handle node storage failure specifically
 *         logger.error("Failed to store node: " + Arrays.toString(e.getKey()), e);
