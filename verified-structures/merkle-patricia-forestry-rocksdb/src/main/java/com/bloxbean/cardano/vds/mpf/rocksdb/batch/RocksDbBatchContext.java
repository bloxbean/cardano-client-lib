...
import com.bloxbean.cardano.vds.rocksdb.exceptions.RocksDbBatchException;
import com.bloxbean.cardano.vds.rocksdb.exceptions.RocksDbOperationException;
import com.bloxbean.cardano.vds.mpf.rocksdb.keys.RocksDbKey;
import org.rocksdb.*;
...
public final class RocksDbBatchContext implements AutoCloseable {
    ...
    public void put(ColumnFamilyHandle cf, RocksDbKey key, byte[] value) throws RocksDbOperationException {
        ...
        try {
            ...
            throw new RocksDbOperationException("PUT", key.toBytes(), e);
        }
    }
    ...
    public byte[] get(ColumnFamilyHandle cf, RocksDbKey key) throws RocksDbOperationException {
        ...
        try {
            ...
            throw new RocksDbOperationException("GET", key.toBytes(), e);
        }
    }
    ...
    public void delete(ColumnFamilyHandle cf, RocksDbKey key) throws RocksDbOperationException {
        ...
        try {
            ...
            throw new RocksDbOperationException("DELETE", key.toBytes(), e);
        }
    }
