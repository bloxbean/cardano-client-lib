 ...
 * All keys extend the {@link com.bloxbean.cardano.vds.mpt.rocksdb.keys.RocksDbKey}
 * base class and provide specific validation and formatting logic.</p>
 *
 * <p><b>Key Types:</b></p>
 * <ul>
 *   <li>{@link com.bloxbean.cardano.vds.mpt.rocksdb.keys.NodeHashKey} - 32-byte node hash keys</li>
 *   <li>{@link com.bloxbean.cardano.vds.mpt.rocksdb.keys.VersionKey} - 8-byte version keys for roots</li>
 *   <li>{@link com.bloxbean.cardano.vds.mpt.rocksdb.keys.SpecialKey} - String-based metadata keys</li>
 *   <li>{@link com.bloxbean.cardano.vds.mpt.rocksdb.keys.RefcountKey} - Reference count keys for GC</li>
 * </ul>
 *
 * <p><b>Benefits:</b></p>
 * <ul>
 ...
 * @since 0.8.0
 */
package com.bloxbean.cardano.vds.mpt.rocksdb.keys;
