 ...
 * @see com.bloxbean.cardano.vds.jmt.JellyfishMerkleTree#getProofWire(byte[], long)
 * @see com.bloxbean.cardano.vds.jmt.JellyfishMerkleTree#verifyProofWire(byte[], byte[], byte[], boolean, byte[])
 * @since 0.8.0
 */
