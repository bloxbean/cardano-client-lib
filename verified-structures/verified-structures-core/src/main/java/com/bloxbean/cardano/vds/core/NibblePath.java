...
/**
 * Type-safe wrapper for nibble paths used in verifiable data structures.
 *
 ...
 * efficient path compression and key encoding in various tree structures
 * (e.g., Merkle Patricia Tries, Merkle Patricia Forestry).</p>
 *
