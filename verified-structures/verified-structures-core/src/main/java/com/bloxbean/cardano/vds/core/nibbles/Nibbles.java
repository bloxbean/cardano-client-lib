package com.bloxbean.cardano.vds.core.nibbles;
 ...
 *
 * <p>Nibbles represent 4-bit values (0-15) used for hexary (16-way) branching in various
 * verifiable data structures. For example, Merkle Patricia Tries use nibble-based branching
 * for key encoding and path traversal. This class provides:</p>
 * <ul>
