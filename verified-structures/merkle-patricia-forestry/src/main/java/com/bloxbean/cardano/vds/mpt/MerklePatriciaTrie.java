...
/**
 * Low-level Merkle Patricia Trie implementation for advanced use cases.
 *
 * <p><b>⚠️ WARNING: For Cardano developers, use {@link MpfTrie} instead!</b></p>
 *
 * <p><b>This class is intended for advanced use cases only:</b></p>
 * <ul>
 *   <li>Off-chain indexing requiring prefix queries on original keys</li>
 *   <li>Performance benchmarking with predictable key patterns</li>
 *   <li>Non-Cardano applications needing raw MPT access</li>
 * </ul>
 *
 * <p><b>For Cardano smart contracts and Aiken compatibility, always use {@link MpfTrie}.</b></p>
 *
 ...
 * <ul>
 *   <li>Building Cardano smart contracts → use {@link MpfTrie}</li>
 *   <li>Storing untrusted keys (vulnerable to DoS) → use {@link MpfTrie}</li>
 *   <li>Need Aiken compatibility → use {@link MpfTrie}</li>
 * </ul>
 *
