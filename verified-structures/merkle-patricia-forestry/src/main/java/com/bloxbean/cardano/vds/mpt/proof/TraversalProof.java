 ...
 *
 * <h2>Usage</h2>
 * <p>This class is package-private in its usage - it's created by {@code MpfTrieImpl.getProof()}
 * and consumed by {@link ProofSerializer} to produce the wire format. End users typically
 * interact with the higher-level {@code MpfTrie.getProofWire()} method.</p>
 *
 * @see WireProof
 * @see ProofSerializer
 * @see ProofVerifier
