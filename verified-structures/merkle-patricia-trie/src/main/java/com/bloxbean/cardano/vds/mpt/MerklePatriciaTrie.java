 ...
 *
 * <p><b>⚠️ CARDANO DEVELOPERS: For on-chain compatibility, use {@link SecureTrie} instead.</b></p>
 *
 ...
 * <ul>
 *   <li>Building Cardano smart contracts → use {@link SecureTrie}</li>
 *   <li>Storing untrusted keys (vulnerable to DoS) → use {@link SecureTrie}</li>
 *   <li>Need Aiken compatibility → use {@link SecureTrie}</li>
 * </ul>
 *
