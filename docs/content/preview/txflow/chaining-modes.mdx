---
title: "Legacy: Chaining Modes"
description: "Compatibility reference for preview SEQUENTIAL, PIPELINED, and BATCH modes"
---

# Legacy: Chaining Modes

> **Compatibility API:** This page documents execution modes on the preview `FlowExecutor`. For
> current execution semantics, see [Execution Engine](./execution-engine) and
