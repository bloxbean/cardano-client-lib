---
title: "Legacy: Building Flows"
description: "Compatibility reference for the preview TxFlow and FlowStep builder API"
---

# Legacy: Building Flows

> **Compatibility API:** This page documents the preview builder and `FlowExecutor` model. For new
> code, start with [Getting Started](./getting-started) and [Portable Authoring](./portable-authoring).
