...
For CIP-20 compliant message metadata, use the dedicated `MessageMetadata` class from the CIP20 module instead of building the label-674 structure manually. See the [CIP20 API page](/apis/standards/cip20-api) for details.
