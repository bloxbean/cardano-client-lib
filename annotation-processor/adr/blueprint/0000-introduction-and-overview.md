...
16. **[ADR-0016](0016-nested-interface-variant-generation.md)** — anyOf variants in sub-packages
...
BlueprintAnnotationProcessor.process()               [ADR-0001]
        ...
        │    │    │              + variant classes in sub-package
...
| [0016](0016-nested-interface-variant-generation.md) | Interface Variant Generation | anyOf variants in sub-packages (e.g., `model.credential.VerificationKey`) |
