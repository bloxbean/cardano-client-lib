...
class ReachabilityMetadataTest {
    ...
    private static final String METADATA =
            "/META-INF/native-image/com.bloxbean.cardano/cardano-client-transaction-spec/reachability-metadata.json";
    /** Packages (including sub-packages) whose classes Jackson binds reflectively. */
    private static final List<String> RECURSIVE_PACKAGES = List.of("com.bloxbean.cardano.client.transaction.spec");
