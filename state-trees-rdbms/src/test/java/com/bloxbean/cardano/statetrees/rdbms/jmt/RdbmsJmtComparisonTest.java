package com.bloxbean.cardano.statetrees.rdbms.jmt;
...
class RdbmsJmtComparisonTest {
    ...
    private void compareRootNodeContent(String label, com.bloxbean.cardano.statetrees.jmt.store.JmtStore store, long version) throws Exception {
        System.out.println("\n  " + label + " root node at version " + version + ":");
        Optional<com.bloxbean.cardano.statetrees.jmt.store.JmtStore.NodeEntry> rootEntry =
