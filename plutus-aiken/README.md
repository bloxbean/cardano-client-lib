...
3.0 and 3.1**. The v3.1.0 release adds helper functions only, no new types
or schema changes, so the v3.0 schemas registered by
`AikenBlueprintTypeRegistry` cover 3.1 unchanged.
