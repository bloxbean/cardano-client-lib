...
class MintCreatorsTest extends BaseTest {
    ...
    void mintCreator_whenPlutusScript() throws Exception {
        PlutusV1Script mintScript1 = PlutusV1Script.builder()
                .type("PlutusScriptV1")
        ...
        PlutusV1Script mintScript2 = PlutusV1Script.builder()
                .type("PlutusScriptV1")
        ...
        assertThat(transaction.getBody().getMint()).contains(multiAsset1, multiAsset2);
        assertThat(transaction.getWitnessSet().getPlutusV1Scripts()).containsExactly(mintScript1, mintScript2);
        assertThat(transaction.getAuxiliaryData().getPlutusV1Scripts()).containsExactly(mintScript1, mintScript2);
    }
}
